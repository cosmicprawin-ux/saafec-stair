...
Then obtain these external dependencies from their official sources:
...
The four SAAFEC-STAIR inference checkpoints are already included in
[`inference_checkpoints/`](../inference_checkpoints/README.md). Configure
their runtime paths or copy them into `assets/checkpoints/` as described in
the checkpoint guide.

The exact sources and destinations are documented in
[EXTERNAL_ASSETS.md](EXTERNAL_ASSETS.md) and
[CHECKPOINTS.md](CHECKPOINTS.md). External dependencies and runtime copies under
