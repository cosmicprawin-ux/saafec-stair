...
A manuscript describing SAAFEC-STAIR is in preparation. Publication details
will be added when the paper is available.
...
This document covers methods and software used by the inference package.
Dataset and structure sources are documented with the supporting data.
