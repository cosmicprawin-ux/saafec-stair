...
It loads each seed's checkpoint, predicts full DDG matrices, and averages the
three seed predictions before writing user-facing outputs.
"""
...
from inference.ensemble_outputs import ensemble_seed_matrices  # noqa: E402
...
from inference.seed_inference import run_inference  # noqa: E402
...
def main() -> None:
    ...
    seed_full_matrices = run_seed_packages(
        loader=loader,
        device=device,
